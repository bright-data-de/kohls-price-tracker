...
[![Kohl's Price Tracker](https://img.shields.io/badge/Kohl's%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/kohls)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/kohls)

Kohl's-Preisverfolgung in Echtzeit – eine US-amerikanische Kaufhauskette im mittleren Preissegment. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder eine **Self-Service-API**, um Ihre eigene Pipeline zu erstellen.

---

## Option 1: Bright Insights - KI-gestütztes Price Tracking (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/kohls)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Kohl's-Preise überwachen** über alle Produktkategorien hinweg
...
> **Ab $250/Monat - [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/kohls)**

---

## Option 2: Self-Service über Web Scraper API

Möchten Sie lieber Ihre eigene Pipeline erstellen? Die **Web Scraper API** von Bright Data bietet Ihnen programmatischen Zugriff auf Kohl's-Produktdaten – Preise, Verfügbarkeit, Bewertungen und mehr – ohne dass Sie Proxys oder Scraping-Infrastruktur verwalten müssen.
...
- Eine Bright Data **Web Scraper ID** für Kohl's-Produkte ([finden Sie Ihre im Web Scrapers Control Panel](https://brightdata.de/cp/scrapers))
...
1. **Dieses repository klonen**
   ...
   ```bash
   git clone https://github.com/bright-data-de/kohls-price-tracker.git
   cd kohls-price-tracker
   ```
...
3. **Zugangsdaten konfigurieren**
   ...
   > suchen Sie nach "Kohl's" und kopieren Sie die Web Scraper ID (Format: `gd_xxxxxxxxxxxx`).
...
Übergeben Sie eine Liste von Kohl's-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.kohls.com/product/sample-item-123456",
...
Sammeln Sie alle Produkte von einer Kohl's-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://kohls.com/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.kohls.com/product/sample-item-123456",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://kohls.com/images/product1.jpg"],
...
inputs = [{"url": "https://www.kohls.com/product/sample-item-123456"}]
...
- 🌟 [Kohl's Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/kohls)
- 🔧 [Kohl's Scraper API](https://brightdata.de/products/web-scraper/kohls)
